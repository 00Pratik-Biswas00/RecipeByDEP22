...
function Profile(){
    ...
    <div className="bg-gray-100 min-h-screen px-6 py-8">
      ...
      <div className="flex items-center gap-6 mt-6 bg-white p-6 rounded-lg h-620">
        <img
          src="https://images.icon-icons.com/2643/PNG/512/female_woman_user_people_avatar_white_tone_icon_159354.png"
          alt="User"
          className="rounded-full w-40 h-40 object-cover"
        />
        <div>
          <h2 className="text-2xl text-green-700 font-bold">PERSON NAME</h2>
          <p className="text-gray-600 flex items-center gap-1">
            <span>📍</span> Region and Country
          </p>
        </div>
      </div>
